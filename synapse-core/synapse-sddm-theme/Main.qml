...
Item {
    ...
    MouseArea {
            ...
            initialItem: Login {
                ...
                notificationMessage: {
                    ...
                    if (capsLockState.locked) {
                        parts.push(i18ndc("synapse-genesis", "@info:status",  "Caps Lock is on"));
                    }
                ...
                actionItems: [
                    ActionButton {
                        ...
                        text: i18ndc("synapse-genesis", "Suspend to disk", "Hibernate")
                        onClicked: sddm.hibernate()
                        enabled: sddm.canHibernate
                    },
                    ActionButton {
                        icon.name: "system-suspend"
                        text: i18ndc("synapse-genesis", "@action:button Suspend to RAM", "Sleep")
                        onClicked: sddm.suspend()
                        enabled: sddm.canSuspend
                    },
                    ActionButton {
                        icon.name: "system-reboot"
                        text: i18ndc("synapse-genesis", "@action:button", "Restart")
                        onClicked: sddm.reboot()
                        enabled: sddm.canReboot
                    },
                    ActionButton {
                        icon.name: "system-shutdown"
                        text: i18ndc("synapse-genesis", "@action:button", "Shut Down")
                        onClicked: sddm.powerOff()
                        enabled: sddm.canPowerOff
                    },
                    ActionButton {
                        icon.name: "system-user-prompt"
                        text: i18ndc("synapse-genesis", "@action:button For switching to a username and password prompt", "Other…")
            ...
            Login {
                ...
                userListModel: ListModel {
                    ...
                    Component.onCompleted: {
                        ...
                        setProperty(0, "name", i18ndc("synapse-genesis", "@info:usagetip", "Type in Username and Password"));
                ...
                actionItems: [
                    ...
                    ActionButton {
                        ...
                        text: i18ndc("synapse-genesis", "@action:button", "List Users")
        ...
        RowLayout {
            ...
            PlasmaComponents3.ToolButton {
                ...
                text: i18ndc("synapse-genesis", "Button to show/hide virtual keyboard", "Virtual Keyboard")
    ...
    Connections {
        ...
        function onLoginFailed() {
            notificationMessage = i18ndc("synapse-genesis", "@info:status", "Login Failed")
            footer.enabled = true
